...
__code uint8_t CfgDesc[] ={
    ...
    0x09,0x04,0x00,0x00,0x02,0x03,0x01,0x00,0x00,    // 2 endpoints
...
__code uint8_t ReportDesc[] ={
	...
	0x29, 0x3f,			//   Usage Maximum 63 input usages total (0x01 to 0x3f)
	0x15, 0x01,			//   Logical Minimum (data bytes in the report may have minimum value = 0x00)
	0x25, 0x40,			//   Logical Maximum (data bytes in the report may have maximum value = 0x00FF = unsigned 255)
	0x75, 0x08,			//   Report Size: 8-bit field size
	0x95, 0x3f,			//   Report Count: Make eight 8-bit fields (the next time the parser hits an "Input", "Output", or "Feature" item)
	0x81, 0x00,			//   Input (Data, Array, Abs): Instantiates input packet fields based on the above report size, count, logical min/max, and usage.
	0x19, 0x01,			//   Usage Minimum 
	0x29, 0x3f,			//   Usage Maximum 63 output usages total (0x01 to 0x3f)
